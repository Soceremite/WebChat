<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserFreeze.aspx.cs" Inherits="WebChat.Admin.UserFreeze" MasterPageFile="/Menu.Master" Title="账号冻结" %>
    ...
    <div>
        ...
        <asp:GridView ID="gv1" runat="server" CssClass="gv_table" CellPadding="4" ForeColor="Black" GridLines="Vertical"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <HeaderStyle Width="8%" />
                    <HeaderTemplate>冻结</HeaderTemplate>
                    <ItemTemplate>
                        <asp:Button ID="btban" runat="server" OnClick="Ban_Click" CssClass="my_button" Text="冻结" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
